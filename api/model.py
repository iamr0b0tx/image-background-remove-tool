...
class U2NET:
    ...
    def __init__(self):
        name = "u2net"
        net = U2NET_DEEP()
        model_path = os.path.join("models", name, name + '.pth')
    ...
    def process_image(self, image_bytes, resolution):
        ...
        image_bytes = InMemoryUploadedFile(image_io, None, 'result.png', 'image/png', image_io.tell, None)
        return image_bytes

    def __load_image__(self, image_data: str):
        """
        ...
        # Image.fromarray(image).save("trial.png")
